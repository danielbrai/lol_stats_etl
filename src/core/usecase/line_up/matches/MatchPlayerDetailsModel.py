class MatchPlayerDetailsModel:
    ...
    def __init__(self, assists, bount_level, champ_exp, champion_id, consumables_purchased, damage_dealt_to_objectives,
                 damage_dealt_to_turrets, damage_self_mitigated, deaths, demage_dealt_to_buildings, detector_wards_placed,
                 double_kills, dragon_kills, first_blood_assist, first_blood_kill, first_tower_kill, gold_earned,
                 gold_spent, id, individual_position_id, inhibitor_kills, inhibitor_lost, inhibitor_takedowns,
                 items_purchased, killing_sprees, kills, lane, largest_critical_strike, largest_killing_spree,
                 largest_multi_kill, longest_time_spent_living, magic_damage_dealt, magic_damage_dealt_to_champions,
                 magic_damage_taken, neutral_minions_killed, nexus_kills, nexus_lost, nexus_takedowns, objective_stolen,
                 objective_stolen_assistis, penta_kills, physical_damage_dealt, physical_damage_dealt_to_champions,
                 physical_damage_taken, player_id, quadra_kills, role_id, sight_wards_bought_in_game, team_early_surrendered,
                 team_id, team_position_id, time_ccing_others, time_played, total_damage_dealt, total_damage_dealt_to_champions,
                 total_damage_shielded_on_teammates, total_damage_taken, total_heal, total_heal_on_teammates, total_minions_killed,
                 total_time_cc_dealt, total_time_spent_dead, total_units_healed, triple_kills, true_damage_dealt,
                 true_damage_dealt_to_champions, true_damage_taken, turret_kills, turrets_takedowns, unreal_kills,
        ...
        self.deaths = deaths
        self.demage_dealt_to_buildings = demage_dealt_to_buildings
